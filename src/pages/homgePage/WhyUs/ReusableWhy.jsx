...
export function ReusableWhy({ bg, img, article, head, icon, btn }) {
    ...
    return (
        <div className={`${bg} rounded-2xl justify-between flex py-[50px] px-[70px] gap-[23%] items-center text-white w-full`}>
            ...
            <img src={img} alt={head} className='w-full object-contain' />
        </div>
    )
